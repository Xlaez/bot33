...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		AlertSeaportMinWei:      ethEnvToWei("ALERT_SEAPORT_MIN_ETH", "0.02"),
		AlertNotifyMinScore:     getenvFloat("ALERT_NOTIFY_MIN_SCORE", 75),
		AlertHeatWindow:         getenvDuration("ALERT_HEAT_WINDOW", 30*time.Minute),
		AlertHeatMinSales:       int(getenvInt64("ALERT_HEAT_MIN_SALES", 5)),
